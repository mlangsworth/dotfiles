...
# Path to your oh-my-zsh installation.
  export ZSH=/home/mlangsworth/.oh-my-zsh
...
plugins=(git github gnu-utils history-substring-search zsh-syntax-highlighting)
...
function cdm() {
  if [[ "$1" != "" ]];
  then
    if [[ "$1" == "/home/mlangsworth" ]];
    then
      cd /mnt/c/Users/mark.langsworth
    else
      cd /mnt/c/$1
    fi
  fi
